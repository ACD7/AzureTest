...
if (PMA_ifSetOr($_POST['submit_clear'], '')) {
    ...
    header('Location: index2.php' . PMA_URL_getCommon());
    exit;
    ...
    header('HTTP/1.1 303 See Other');
    header('Location: index2.php' . PMA_URL_getCommon() . '&action_done=config_saved');
    exit;
    ...
    //
    header('HTTP/1.1 303 See Other');
    header('Location: index2.php' . PMA_URL_getCommon() . '&page=config');
    exit;
}
